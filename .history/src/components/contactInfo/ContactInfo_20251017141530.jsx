      ...
      <div className="contact__container" style={{ margin: "0 1.5rem" }}>
        ...
        <div className="contact__content section">
          <div className="contact__info">
            ...
            <p className="contact__street title-text">1413 W Baltimore Streett</p>
            <p className="contact__postal title-text">Baltimore, MD 21215</p>
            ...
            <span> londonsbblc@gmail.com</span>
