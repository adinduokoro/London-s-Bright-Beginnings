...
import myFile from "../../assets/documents/c"
        ...
        <div className="footer">
          <div className="footer__logo">
            ...
            <p className="label-text">
              © {year} London’s Bright Beginnings. Created by <a className="designer__link" href="https://bytebackdigital.com/" target="_blank">Byte Back Digital</a>.
              All rights reserved.
            </p>
          </div>
          ...
          <div className="footer__contact">
            ...
            <ul>
              {footerContact.map((info, index) => {
                return (
                  <div key={index} className="label-text">
                    <p onClick={() => window.open()}>Emergency Form</p>
                  </div>
                );
              })}
            </ul>
